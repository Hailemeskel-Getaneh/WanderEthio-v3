...
<HeaderHiking/>
    <div className="hiking-container">
      ...
      <section className="section">
        ...
        <img src={SimienMountainsImage} alt="Simien Mountains" className="section-image" />
      ...
      <section className="section">
        ...
        <img src={BaleMountainsImage} alt="Bale Mountains" className="section-image" />
        <p className="section-text-p">
      ...
      <section className="section">
        ...
        <img src={DanakilDepressionImage} alt="Danakil Depression" className="section-image" />
        <p className="section-text-p">
      ...
      <section className="section">
        <h2>Omo Valley</h2>
        <img src={OmoValleyImage} alt="Omo Valley" className="section-image" />
        <p className="section-text-p">
      ...
      <section className="section">
        ...
        <img src={BlueNileFallsImage} alt="Blue Nile Falls" className="section-image" />
        <p className="section-text-p">
