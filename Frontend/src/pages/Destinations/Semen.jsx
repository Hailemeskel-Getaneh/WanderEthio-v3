...
const faqs = [
  ...
  return (
    ...
    <div className='tempofooter'></div>
        ...
        <h2 className="semen-section-title">FAQs</h2>
        <hr />
...
<ul className="faq-list">
      {faqs.map((faq, index) => (
        ...
        <iframe  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1670541.8047233776!2d36.8717834813434!3d13.466849002721801!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1669c1d46d16f89d%3A0x770284df7312622d!2sSimien%20Mountains%20National%20Park!5e0!3m2!1sen!2set!4v1717334175196!5m2!1sen!2set" width="600" height="450"   
        style={{ border: 0 }}
        allowfullscreen=""
         loading="lazy" ></iframe>
          <p className="semen-section-text">
