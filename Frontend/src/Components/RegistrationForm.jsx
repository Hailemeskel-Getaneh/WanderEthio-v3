...
import HeaderRegistration from './headerRegister.jsx';
...
const RegistrationForm = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('http://localhost:4000/api/register/registration', formData);
      ...
      <div className='mainRegistrationBody'>
        ...
        <div className="registration-form-container">
          <form className="registration-form" onSubmit={handleSubmit}>
           ...
           <  input type="password" id="password" placeholder='create your new password in wander ethio' name="password" value={formData.password} onChange={handleChange} required />
            </div>
            <div className="form-group">
